...
void DrawSkyWay_00(int rideIndex, int colorIndex)
{
	...
	glBindTexture (GL_TEXTURE_2D, texture_id[TEXTURE_RIDE_12_00] );
	...
	glPushMatrix();
		glTranslated(0.0f, SKYWAY_HEIGHT * UNITHEIGHT, 0.0f);
...
void DrawSkyWay_32(int rideIndex, int colorIndex)
{
	...
	glPushMatrix();
		...
		glTranslated(0.0f * UNITWIDTH, SKYWAY_HEIGHT * UNITHEIGHT, 1.0f * UNITWIDTH);
...
void DrawSkyWay_33(int rideIndex, int colorIndex)
{
	...
	glPushMatrix();
		...
		glTranslated(0.0f, SKYWAY_HEIGHT * UNITHEIGHT, -1.0f * UNITWIDTH);
