...
public:
	...
	bool load(unsigned char *gameData);
	bool loadOffset(unsigned char *gameData, int x, int y);
	...
	void clear(void);
	bool draw(unsigned char x1, unsigned char z1, unsigned char x2, unsigned char z2);
private:
