#include "vr3d.h"
#define MINETRAIN_ANGLEHEIGHT	1.5f
...
void DrawMineTrain_00(int rideIndex, int colorIndex, bool isDiag)
{
	...
	glBindTexture (GL_TEXTURE_2D, texture_id[TEXTURE_RIDE_11_00] );
	...
	glBindTexture (GL_TEXTURE_2D, texture_id[TEXTURE_RIDE_11_01] );
...
void DrawMineTrain_12(int rideIndex, int colorIndex, bool isDiag)
{
	...
	glBegin(GL_QUADS);
		...
		glTexCoord2d(1.0f, 1.0f);	  
		glVertex3d(UNITWIDTH,	MINETRAIN_ANGLEHEIGHT, segWid * UNITWIDTH);
	...
	glBegin(GL_QUADS);
		...
		glVertex3d(0.0f,		0.05f, segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 1.0f);	  
		glVertex3d(UNITWIDTH,	MINETRAIN_ANGLEHEIGHT + 0.05f, segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 0.0f);
		glVertex3d(UNITWIDTH,	0.05f, 0.0f);
	glEnd();
...
void DrawMineTrain_13(int rideIndex, int colorIndex, bool isDiag)
{
	...
	glBegin(GL_QUADS);
		...
		glVertex3d(UNITWIDTH,	0.0f, segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 0.0f);
		glVertex3d(UNITWIDTH,	MINETRAIN_ANGLEHEIGHT, 0.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glVertex3d(UNITWIDTH,	0.05f, segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 0.0f);
		glVertex3d(UNITWIDTH,	MINETRAIN_ANGLEHEIGHT + 0.05f, 0.0f);
	glEnd();
...
void DrawMineTrain_14(int rideIndex, int colorIndex, bool isDiag)
{
	...
	glBegin(GL_QUADS);
		...
		glTexCoord2d(0.0f, 1.0f);				
		glVertex3d(0.0f,		MINETRAIN_ANGLEHEIGHT, segWid * UNITWIDTH);
...
void DrawMineTrain_15(int rideIndex, int colorIndex, bool isDiag)
{
	...
	glBegin(GL_QUADS);
		glTexCoord2d(0.0f, 0.0f);
		glVertex3d(0.0f,		MINETRAIN_ANGLEHEIGHT, 0.0f);
		glTexCoord2d(0.0f, 1.0f);				
		glVertex3d(0.0f,		0.0f, segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 1.0f);	  
		glVertex3d(UNITWIDTH,	0.0f, segWid * UNITWIDTH);
	...
	glBegin(GL_QUADS);
		glTexCoord2d(0.0f, 0.0f);
		glVertex3d(0.0f,		MINETRAIN_ANGLEHEIGHT + 0.05f, 0.0f);
		glTexCoord2d(0.0f, 1.0f);				
		glVertex3d(0.0f,		0.05f, segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 1.0f);	  
		glVertex3d(UNITWIDTH,	0.05f, segWid * UNITWIDTH);
...
void DrawMineTrain_16(int rideIndex, int colorIndex)
{
	...
	for(i=0; i<4; i++)
	{
		glBegin(GL_QUADS);
			...
			glVertex3d(radius1 * sin(degrees[i]),	0.0f, (-1.0f * UNITWIDTH + radius1 * cos(degrees[i])));
			glTexCoord2d(0.0, 1.0);
			glVertex3d(radius2 * sin(degrees[i]),	0.0f + MINETRAIN_ANGLEHEIGHT, (-1.0f * UNITWIDTH + radius2 * cos(degrees[i])));
			glTexCoord2d(1.0, 1.0);
			glVertex3d(radius2 * sin(degrees[i+1]),	0.0f + MINETRAIN_ANGLEHEIGHT, (-1.0f * UNITWIDTH + radius2 * cos(degrees[i+1])));
			glTexCoord2d(1.0, 0.0);
			glVertex3d(radius1 * sin(degrees[i+1]),	0.0f, (-1.0f * UNITWIDTH + radius1 * cos(degrees[i+1])));
		glEnd();
	}
	...
	for(i=0; i<4; i++)
	{
		glBegin(GL_QUADS);
			...
			glVertex3d(radius1 * sin(degrees[i]),	0.05f, (-1.0f * UNITWIDTH + radius1 * cos(degrees[i])));
			glTexCoord2d(0.0, 1.0);
			glVertex3d(radius2 * sin(degrees[i]),	0.05f + MINETRAIN_ANGLEHEIGHT, (-1.0f * UNITWIDTH + radius2 * cos(degrees[i])));
			glTexCoord2d(1.0, 1.0);
			glVertex3d(radius2 * sin(degrees[i+1]),	0.05f + MINETRAIN_ANGLEHEIGHT, (-1.0f * UNITWIDTH + radius2 * cos(degrees[i+1])));
			glTexCoord2d(1.0, 0.0);
			glVertex3d(radius1 * sin(degrees[i+1]),	0.05f, (-1.0f * UNITWIDTH + radius1 * cos(degrees[i+1])));
		glEnd();
	}
...
void DrawMineTrain_17(int rideIndex, int colorIndex)
{
	...
	for(i=0; i<4; i++)
	{
		glBegin(GL_QUADS);
			//-UNITWIDTH + radius * UNITWIDTH * cos(degrees[i])
			glTexCoord2d(0.0, 0.0);
			glVertex3d(radius1 * sin(degrees[i]),	0.0f + MINETRAIN_ANGLEHEIGHT, -1.0f * (-2.0f * UNITWIDTH + radius1 * cos(degrees[i])));
			glTexCoord2d(0.0, 1.0);
			glVertex3d(radius2 * sin(degrees[i]),	0.0f, -1.0f * (-2.0f * UNITWIDTH + radius2 * cos(degrees[i])));
			glTexCoord2d(1.0, 1.0);
			glVertex3d(radius2 * sin(degrees[i+1]),	0.0f, -1.0f * (-2.0f * UNITWIDTH + radius2 * cos(degrees[i+1])));
			glTexCoord2d(1.0, 0.0);
			glVertex3d(radius1 * sin(degrees[i+1]),	0.0f + MINETRAIN_ANGLEHEIGHT, -1.0f * (-2.0f * UNITWIDTH + radius1 * cos(degrees[i+1])));
		glEnd();
	}
	...
	for(i=0; i<4; i++)
	{
		glBegin(GL_QUADS);
			//-UNITWIDTH + radius * UNITWIDTH * cos(degrees[i])
			glTexCoord2d(0.0, 0.0);
			glVertex3d(radius1 * sin(degrees[i]),	0.05f + MINETRAIN_ANGLEHEIGHT, -1.0f * (-2.0f * UNITWIDTH + radius1 * cos(degrees[i])));
			glTexCoord2d(0.0, 1.0);
			glVertex3d(radius2 * sin(degrees[i]),	0.05f, -1.0f * (-2.0f * UNITWIDTH + radius2 * cos(degrees[i])));
			glTexCoord2d(1.0, 1.0);
			glVertex3d(radius2 * sin(degrees[i+1]),	0.05f, -1.0f * (-2.0f * UNITWIDTH + radius2 * cos(degrees[i+1])));
			glTexCoord2d(1.0, 0.0);
			glVertex3d(radius1 * sin(degrees[i+1]),	0.05f + MINETRAIN_ANGLEHEIGHT, -1.0f * (-2.0f * UNITWIDTH + radius1 * cos(degrees[i+1])));
		glEnd();
	}
	glDisable(GL_TEXTURE_2D);
}
...
void DrawMineTrain_18(int rideIndex, int colorIndex, bool isDiag)
{
	...
	glBegin(GL_QUADS);
		...
		glVertex3d(0.0f,		0.05f,		0.0f);
		glTexCoord2d(0.0f, 1.0f);				
		glVertex3d(0.0f,		MINETRAIN_ANGLEHEIGHT + 0.05f,		segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 1.0f);	  
		glVertex3d(UNITWIDTH,	0.5f * UNITHEIGHT + 0.05f,	segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 0.0f);
		glVertex3d(UNITWIDTH,	0.5f * UNITHEIGHT + 0.05f,	0.0f);
...
void DrawMineTrain_1A(int rideIndex, int colorIndex, bool isDiag)
{
	...
	glBegin(GL_QUADS);
		...
		glVertex3d(0.0f,		0.0f,		segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 1.0f);	  
		glVertex3d(UNITWIDTH,	0.5f * UNITHEIGHT + MINETRAIN_ANGLEHEIGHT,	segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 0.0f);
		glVertex3d(UNITWIDTH,	0.5f * UNITHEIGHT,	0.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glVertex3d(0.0f,		0.05f,		segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 1.0f);	  
		glVertex3d(UNITWIDTH,	0.5f * UNITHEIGHT + 0.05f + MINETRAIN_ANGLEHEIGHT,	segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 0.0f);
		glVertex3d(UNITWIDTH,	0.5f * UNITHEIGHT + 0.05f,	0.0f);
	glEnd();
...
void DrawMineTrain_1B(int rideIndex, int colorIndex, bool isDiag)
{
	...
	glBegin(GL_QUADS);
		...
		glVertex3d(UNITWIDTH,	0.5f * UNITHEIGHT,	segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 0.0f);
		glVertex3d(UNITWIDTH,	0.5f * UNITHEIGHT + MINETRAIN_ANGLEHEIGHT,	0.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glVertex3d(UNITWIDTH,	0.5f * UNITHEIGHT + 0.05f,	segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 0.0f);
		glVertex3d(UNITWIDTH,	0.5f * UNITHEIGHT + MINETRAIN_ANGLEHEIGHT + 0.05f,	0.0f);
	glEnd();
...
void DrawMineTrain_1C(int rideIndex, int colorIndex, bool isDiag)
{
	...
	glBegin(GL_QUADS);
		...
		glVertex3d(0.0f,		0.5f * UNITHEIGHT,		0.0f);
		glTexCoord2d(0.0f, 1.0f);				
		glVertex3d(0.0f,		0.5f * UNITHEIGHT + MINETRAIN_ANGLEHEIGHT,		segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 1.0f);	  
		glVertex3d(UNITWIDTH,	0.0f,			segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 0.0f);
		glVertex3d(UNITWIDTH,	0.0f,			0.0f);
	...
	glBegin(GL_QUADS);
		...
		glVertex3d(0.0f,		0.5f * UNITHEIGHT + 0.05f,		0.0f);
		glTexCoord2d(0.0f, 1.0f);				
		glVertex3d(0.0f,		0.5f * UNITHEIGHT + MINETRAIN_ANGLEHEIGHT + 0.05f,		segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 1.0f);	  
		glVertex3d(UNITWIDTH,	0.05f,			segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 0.0f);
		glVertex3d(UNITWIDTH,	0.05f,			0.0f);
...
void DrawMineTrain_1D(int rideIndex, int colorIndex, bool isDiag)
{
	...
	glBegin(GL_QUADS);
		glTexCoord2d(0.0f, 0.0f);
		glVertex3d(0.0f,		0.5f * UNITHEIGHT + MINETRAIN_ANGLEHEIGHT,		0.0f);
		glTexCoord2d(0.0f, 1.0f);				
		glVertex3d(0.0f,		0.5f * UNITHEIGHT,		segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 1.0f);	  
		glVertex3d(UNITWIDTH,	0.0f,			segWid * UNITWIDTH);
	...
	glBegin(GL_QUADS);
		glTexCoord2d(0.0f, 0.0f);
		glVertex3d(0.0f,		0.5f * UNITHEIGHT + MINETRAIN_ANGLEHEIGHT + 0.05f,		0.0f);
		glTexCoord2d(0.0f, 1.0f);				
		glVertex3d(0.0f,		0.5f * UNITHEIGHT + 0.05f,		segWid * UNITWIDTH);
		glTexCoord2d(1.0f, 1.0f);	  
		glVertex3d(UNITWIDTH,	0.05f,			segWid * UNITWIDTH);
...
void DrawMineTrain_8A(int rideIndex, int colorIndex)
{
	...
	for(i=0; i<4; i++)
	{
		glBegin(GL_QUADS);
			...
			glVertex3d(radius1 * sin(degrees[i]),	0.0f, -1.0f * (-2.0f * UNITWIDTH + radius1 * cos(degrees[i])));
			glTexCoord2d(0.0f, 1.0f);
			glVertex3d(radius2 * sin(degrees[i]), 	0.0f + MINETRAIN_ANGLEHEIGHT, -1.0f * (-2.0f * UNITWIDTH + radius2 * cos(degrees[i])));
			glTexCoord2d(1.0f, 1.0f);
			glVertex3d(radius2 * sin(degrees[i+1]), 0.0f + MINETRAIN_ANGLEHEIGHT, -1.0f * (-2.0f * UNITWIDTH + radius2 * cos(degrees[i+1])));
			glTexCoord2d(1.0f, 0.0f);
			glVertex3d(radius1 * sin(degrees[i+1]), 0.0f, -1.0f * (-2.0f * UNITWIDTH + radius1 * cos(degrees[i+1])));
		glEnd();
	}
	...
	for(i=0; i<4; i++)
	{
		glBegin(GL_QUADS);
			...
			glVertex3d(radius1 * sin(degrees[i]),	0.05f, -1.0f * (-2.0f * UNITWIDTH + radius1 * cos(degrees[i])));
			glTexCoord2d(0.0f, 1.0f);
			glVertex3d(radius2 * sin(degrees[i]), 	0.05f + MINETRAIN_ANGLEHEIGHT, -1.0f * (-2.0f * UNITWIDTH + radius2 * cos(degrees[i])));
			glTexCoord2d(1.0f, 1.0f);
			glVertex3d(radius2 * sin(degrees[i+1]), 0.05f + MINETRAIN_ANGLEHEIGHT, -1.0f * (-2.0f * UNITWIDTH + radius2 * cos(degrees[i+1])));
			glTexCoord2d(1.0f, 0.0f);
			glVertex3d(radius1 * sin(degrees[i+1]), 0.05f, -1.0f * (-2.0f * UNITWIDTH + radius1 * cos(degrees[i+1])));
		glEnd();
	}
...
{	
	glPushMatrix();
		...
		DrawMineTrain_00(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_04(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_05(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_06(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_07(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_0A(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_0B(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_0C(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_0D(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_12(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_13(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_14(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_15(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_18(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_19(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_1A(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_1B(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_1C(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_1D(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_1E(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_1F(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_20(rideIndex, colorIndex, true);
...
{	
	glPushMatrix();
		...
		DrawMineTrain_21(rideIndex, colorIndex, true);
